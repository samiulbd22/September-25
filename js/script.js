...
const members = {
    ...
    serviceBill     :20,
    othersBill      :200,
    runningMonth    :"September-25",
    previousMonth   :"August-25", // new addDecember link https://grabify.link/38DB4J
    upComingMonth   :"October 1,2025",
    runningMealRate :58,
...
//Continue for mass calculating {"04/08/25-Cash":4550}    
    "01922362569":{
        ...
        payment             :{"01/09/25-Cash":580,"10/09/25-DBBL":2000,"22/09/25-Cash":600,"25/09/25-DBBL":500},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :3497,
        running_paid    :3680,
        running_meal    :26,
        // method 
        preMonth,
    ...
    "01797816501":{
        ...
        post_payable        :2486,
        previous_paid       :4500,
        previous_dining_cost:1998,
        payment             :{"10/09/25-Cash":4000,"13/09/25-Cash":1000,"22/09/25-Cash":1000},
        // running month{"04/08/25-Cash":4550}
        stay_cost       :2300,
        garage_cost     :0,
        running_payable :3144,
        running_paid    :6000,
        running_meal    :35,
        // method calling
        preMonth,
    ...
    "01704351658":{
        ...
        post_payable        :4678,
        previous_paid       :5500,
        previous_dining_cost:2970,
        payment             :{"13/09/25-Cash":6400,"22/09/25-Cash":1000},
        // running month
        stay_cost       :2700,
        garage_cost     :0,
        running_payable :5708,
        running_paid    :7400,
        running_meal    :56,
        // method calling
        preMonth,
    ...
    "01581515641":{//01644377150
        ...
        previous_paid       :7200,
        previous_dining_cost:2970,
        payment             :{"10/09/25-Cash":4000,"14/09/25-Cash":1000,"29/09/25-Cash":2500},
        // running month
        stay_cost       :3250,
        garage_cost     :0,
    ...
    "01537664564":{
        ...
        payment             :{"12/09/25-Cash":6000,"28/09/25-Cash":1100},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :5113,
        running_paid    :7100,
        running_meal    :51,
        // method calling
        preMonth,
    ...
    "01909752631":{
        ...
        payment             :{"01/09/25-Cash":2000,"09/09/25-Cash":2000,"12/09/25-Cash":1720,"16/09/25-Cash":1000},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
    ...
    "01934147404":{
        ...
        payment             :{"01/09/25-Cash":1000,"04/09/25-Cash":3500,"07/09/25-Cash":1000,"13/09/25-Dss":200,"25/09/25-Cash":500} ,
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4245,
        running_paid    :6200,
        running_meal    :31,
        // method calling
        preMonth,
	...
	"01639523533":{
        ...
        previous_paid       :7500,
        previous_dining_cost:1350,
        payment             :{"01/09/25-Cash":2000,"01/09/25-Dmiss":2400,"15/09/25-Cash":1500},
        // running month {"01/07/24-Cash":500}
        stay_cost       :4200,
        garage_cost     :0,
        running_payable :4510,
        running_paid    :5900,
        running_meal    :29,
        // method calling
        preMonth,
    ...
    "01920056090":{
        ...
        previous_paid       :5000,
        previous_dining_cost:1350,
        payment             :{"04/09/25-Cash":3500,"15/09/25-Cash":1000,"24/09/25-Cash":1000,"24/09/25-Dmss":200},
        // running month
        stay_cost       :2400,
        garage_cost     :0,
        running_payable :2151,
        running_paid    :5700,
        running_meal    :41,
        // method calling
        preMonth,
	...
	"01821245430":{
        ...
        payment             :{"07/09/25-Cash":500,"14/09/25-Cash":1000,"21/09/25-Cash":500,"24/09/25-Cash":500},
        // running month
        stay_cost       :200,
        garage_cost     :0,
        running_payable :574,
